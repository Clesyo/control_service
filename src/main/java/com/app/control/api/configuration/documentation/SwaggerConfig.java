...
public class SwaggerConfig {
	 ...
	 * 
	 * private List<SecurityReference> defaultAuth() { AuthorizationScope scope =
	 * new AuthorizationScope("global", "accessEverrything");
	 * 
	 * AuthorizationScope[] scopes = new AuthorizationScope[1]; scopes[0] = scope;
	 * 
	 * SecurityReference reference = new SecurityReference("JWT", scopes);
	 * 
	 * List<SecurityReference> auths = new ArrayList<>(); auths.add(reference);
	 * 
	 * return auths;
	 * 
	 * }
